...
### 7. Paru Packages
```bash
paru -S google-chrome obsidian anki ghostty quickshell noctalia-shell hyprlock hypridle jetbrains-toolbox docker docker-compose obs-studio papirus-icon-theme dumbpipe k6 vicinae just
```
